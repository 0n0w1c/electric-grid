...
local huge_pole                      =
{
    ...
    icon                           = constants.EG_ICONS .. "huge-electric-pole.png",
    icon_size                      = 32,
    ...
    pictures                       =
    {
        filename = constants.EG_ENTITIES .. "huge-electric-pole.png",
        priority = "extra-high",
        width = 168,
        height = 165,
        direction_count = 4,
...
huge_pole_item.icon                  = constants.EG_ICONS .. "huge-electric-pole.png"

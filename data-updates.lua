...
data.raw["electric-pole"]["medium-electric-pole"].light = constants.EG_MEDIUM_POLE_LIGHT
...
data.raw["electric-pole"]["big-electric-pole"].light = constants.EG_BIG_POLE_LIGHT
...
if mods["ConnectionBox"] then
    ...
    data.raw["electric-pole"]["connection-box"].minable.mining_time =
        data.raw["electric-pole"]["substation"].minable.mining_time
    data.raw["electric-pole"]["connection-box"].light = constants.EG_MINI_POLE_LIGHT
